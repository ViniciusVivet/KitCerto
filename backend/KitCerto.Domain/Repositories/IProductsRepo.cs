...
namespace KitCerto.Domain.Repositories
{
    public interface IProductsRepo
    {
        ...
        // NOVOS
        Task UpdateAsync(string id, string name, string description, decimal price, int stock, int quantity, string categoryId, IEnumerable<ProductMedia> media, CancellationToken ct);
