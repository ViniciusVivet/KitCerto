...
const products = [
  { _id:'p_1', Name:'Relógio Esmeralda Clássic Cravejado', Description:'Relógio clássico cravejado com detalhes esmeralda. Banhado a ouro, caixa cravejada de strass e pulseira de aço inox.', Price:D('249.95'), CategoryId:'cat_relogio', Quantity:0, Stock:12, CreatedAtUtc:now, Media:[{ Url:'https://images.unsplash.com/photo-1587836374828-4dbafa94cf0e?w=400&h=400&fit=crop&auto=format', Type:'image' }] },
  { _id:'p_2', Name:'Corrente Spike', Description:'Corrente modelo Spike com pingentes pontiagudos. Acabamento banhado a ouro 18k, estilo street e hip-hop.', Price:D('124.95'), CategoryId:'cat_corrente', Quantity:0, Stock:20, CreatedAtUtc:now, Media:[{ Url:'https://images.unsplash.com/photo-1611085583191-a3b181a88401?w=400&h=400&fit=crop&auto=format', Type:'image' }] },
  ...
  { _id:'p_4', Name:'Corrente Poças', Description:'Corrente modelo Poças com elos arredondados e acabamento espelhado. Banhada a ouro 18k.', Price:D('99.95'), CategoryId:'cat_corrente', Quantity:0, Stock:25, CreatedAtUtc:now, Media:[{ Url:'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=400&h=400&fit=crop&auto=format', Type:'image' }] },
  ...
  { _id:'p_6', Name:'Corrente Ninepac Elegante', Description:'Corrente Ninepac com design elegante e acabamento premium. Banhada a prata 925, ideal para looks sofisticados.', Price:D('174.95'), CategoryId:'cat_corrente', Quantity:0, Stock:14, CreatedAtUtc:now, Media:[{ Url:'https://images.unsplash.com/photo-1573408301185-9519f94ef58b?w=400&h=400&fit=crop&auto=format', Type:'image' }] },
